...
const generator_1 = require("./types/generator");
...
void (async () => {
    ...
    await dr.cleanup();
    // Parse and Generate
    const parsedDocs = parser_1.parse(docs, [schema_1.EDocGroup.Script, schema_1.EDocGroup.Components, schema_1.EDocGroup.Extensions]);
    const output = generator_1.generate(parsedDocs, { channel, tag, sha1 }, builtIns_1.default);
